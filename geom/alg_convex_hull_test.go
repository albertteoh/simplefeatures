...
func TestConvexHull(t *testing.T) {
	for _, tt := range []struct {
		...
		// Reproduced a bug.
		{
			input:  `POLYGON((0.9292893218813453 1.0707106781186548,1.1414213562373097 1,0.07071067811865475 -0.07071067811865475,0 -0.1414213562373095,0.9292893218813453 1.0707106781186548))`,
